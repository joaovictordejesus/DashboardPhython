Dashboard de Análise da Obesidade
...
Come_algum_alimento_entre_refeições: É a categoria que define se a pessoa costuma se alimentar no intervalo das refeições, tendo como Algumas,Frequentemente,Sempre e Não. 
...
Originalmente, estavam disponíveisos dados: Idade,Gênero,Altura,Peso,CALC,FAVC,FCVC,NCP,SCC,Habito_de_Fumar,CH2O,Histórico_familiar_de_sobrepeso,
